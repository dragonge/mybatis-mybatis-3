...
public class Reflector {
  ...
  /**
   * String result = getSignature(MyClass.class.getMethod("myMethod", int.class, String.class, boolean.class));
   * "java.lang.String#myMethod:int,java.lang.String,boolean"
   * 返回类型为 java.lang.String
   * 方法名为 myMethod
   * 参数类型分别为 int, java.lang.String, boolean，它们之间用逗号 , 分隔，并且在第一个参数前放置了一个冒号 :
   * @param method
   * @return
   */
